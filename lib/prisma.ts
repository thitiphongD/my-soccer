...
export interface User {
  ...
  export const mockCategories: Category[] = [
    ...
    },
    {
      id: "cat2",
      name: "Technology",
      description: "Tech-related discussions and news",
      createdAt: new Date("2024-01-01"),
      updatedAt: new Date("2024-01-01"),
    },
    {
  ...
  const mockPosts: Post[] = [
    {
      ...
      content: "This is the first post on our new web board platform. Feel free to explore and create your own posts!",
      authorId: "admin1",
      categoryId: "cat4",
    ...
    },
    {
      ...
      authorId: "user1",
      categoryId: "cat2",
      images: ["/placeholder.svg?height=300&width=500", "/placeholder.svg?height=250&width=400"],
      likes: 42,
      createdAt: new Date("2024-01-06"),
      updatedAt: new Date("2024-01-06"),
    },
    ...
    },
    {
      ...
      images: ["/placeholder.svg?height=300&width=600", "/placeholder.svg?height=400&width=500"],
      likes: 29,
    },
    {
      id: "post10",
  ...
  const mockComments: Comment[] = [
    ...
    {
      id: "comment2",
      content: "Thanks for sharing these tips! The React.memo tip is especially useful.",
      authorId: "user2",
      postId: "post2",
      likes: 12,
    ...
    {
      id: "comment3",
      content: "I agree with all of these points. TypeScript has been a game-changer for my projects.",
      authorId: "user3",
      postId: "post2",
      likes: 15,
    ...
    {
      id: "comment6",
      content: "Great list! I'd also add GitLens and Thunder Client to that list.",
      authorId: "user3",
      postId: "post5",
      likes: 9,
    ...
    {
      id: "comment9",
      content: "CSS Grid is perfect for 2D layouts, while Flexbox excels at 1D layouts. Great explanation!",
      authorId: "user5",
      postId: "post7",
      likes: 2,
    ...
    {
      id: "comment10",
      content: "This is exactly what I needed! Do you have any recommendations for authentication middleware?",
      authorId: "user6",
      postId: "post8",
      likes: 7,
    ...
    {
      id: "comment11",
      content: "Love the minimalist trend! Clean designs are so much easier to navigate.",
      authorId: "user4",
      postId: "post9",
      likes: 11,
    ...
    {
      id: "comment12",
      content: "Indexing strategies are crucial! Have you tried using query execution plans to identify bottlenecks?",
      authorId: "user8",
      postId: "post10",
      likes: 1,
    ...
    {
      id: "comment14",
      content: "Another great extension is Live Server for quick development previews.",
      authorId: "user7",
      postId: "post5",
      likes: 13,
    ...
    {
      id: "comment15",
      content: "Join coding communities and find accountability partners. It really helps!",
      authorId: "user8",
      postId: "post6",
      likes: 0,
  ...
  const mockLikes: Like[] = [
    // User1 likes
    { id: "like1", userId: "user1", postId: "post1", createdAt: new Date("2024-01-05T11:00:00") },
    { id: "like2", userId: "user1", postId: "post3", createdAt: new Date("2024-01-07T10:00:00") },
    { id: "like3", userId: "user1", postId: "post7", createdAt: new Date("2024-01-11T16:00:00") },
    { id: "like4", userId: "user1", commentId: "comment4", createdAt: new Date("2024-01-07T10:00:00") },
    { id: "like5", userId: "user1", commentId: "comment7", createdAt: new Date("2024-01-10T09:00:00") },
  
    // User2 likes
    { id: "like6", userId: "user2", postId: "post2", createdAt: new Date("2024-01-06T15:00:00") },
    { id: "like7", userId: "user2", postId: "post4", createdAt: new Date("2024-01-08T12:00:00") },
    { id: "like8", userId: "user2", postId: "post5", createdAt: new Date("2024-01-09T14:00:00") },
    { id: "like9", userId: "user2", commentId: "comment1", createdAt: new Date("2024-01-05T11:00:00") },
    { id: "like10", userId: "user2", commentId: "comment3", createdAt: new Date("2024-01-06T17:00:00") },
    { id: "like11", userId: "user2", commentId: "comment5", createdAt: new Date("2024-01-08T12:00:00") },
  
    // User3 likes
    { id: "like12", userId: "user3", postId: "post1", createdAt: new Date("2024-01-05T12:00:00") },
    { id: "like13", userId: "user3", postId: "post6", createdAt: new Date("2024-01-10T13:00:00") },
    { id: "like14", userId: "user3", postId: "post9", createdAt: new Date("2024-01-13T17:00:00") },
    { id: "like15", userId: "user3", commentId: "comment2", createdAt: new Date("2024-01-06T15:00:00") },
    { id: "like16", userId: "user3", commentId: "comment6", createdAt: new Date("2024-01-09T14:00:00") },
  
    // Admin1 likes
    { id: "like17", userId: "admin1", postId: "post2", createdAt: new Date("2024-01-06T16:00:00") },
    { id: "like18", userId: "admin1", postId: "post5", createdAt: new Date("2024-01-09T15:00:00") },
    { id: "like19", userId: "admin1", postId: "post7", createdAt: new Date("2024-01-11T17:00:00") },
    { id: "like20", userId: "admin1", postId: "post10", createdAt: new Date("2024-01-14T12:00:00") },
    { id: "like21", userId: "admin1", commentId: "comment3", createdAt: new Date("2024-01-06T17:00:00") },
    { id: "like22", userId: "admin1", commentId: "comment8", createdAt: new Date("2024-01-10T13:00:00") },
  
    // User4 likes
    { id: "like23", userId: "user4", postId: "post1", createdAt: new Date("2024-01-05T15:00:00") },
    { id: "like24", userId: "user4", postId: "post8", createdAt: new Date("2024-01-12T11:00:00") },
    { id: "like25", userId: "user4", commentId: "comment9", createdAt: new Date("2024-01-11T16:00:00") },
    { id: "like26", userId: "user4", commentId: "comment11", createdAt: new Date("2024-01-13T17:00:00") },
  
    // User5 likes
    { id: "like27", userId: "user5", postId: "post4", createdAt: new Date("2024-01-08T13:00:00") },
    { id: "like28", userId: "user5", commentId: "comment10", createdAt: new Date("2024-01-12T11:00:00") },
  
    // User6 likes
    { id: "like29", userId: "user6", postId: "post3", createdAt: new Date("2024-01-07T11:00:00") },
    { id: "like30", userId: "user6", postId: "post6", createdAt: new Date("2024-01-10T14:00:00") },
    { id: "like31", userId: "user6", commentId: "comment12", createdAt: new Date("2024-01-14T12:00:00") },
  
    // User7 likes
    { id: "like32", userId: "user7", postId: "post2", createdAt: new Date("2024-01-06T17:00:00") },
    { id: "like33", userId: "user7", postId: "post9", createdAt: new Date("2024-01-13T18:00:00") },
    { id: "like34", userId: "user7", commentId: "comment14", createdAt: new Date("2024-01-09T19:00:00") },
  
    // User8 likes
    { id: "like35", userId: "user8", postId: "post1", createdAt: new Date("2024-01-05T16:00:00") },
    { id: "like36", userId: "user8", commentId: "comment15", createdAt: new Date("2024-01-10T21:00:00") },
  ]
  
  // Helper function to calculate user total likes
  function calculateUserTotalLikes(userId: string): number {
    const postLikes = mockPosts.filter((post) => post.authorId === userId).reduce((sum, post) => sum + post.likes, 0)
  ...
  export const prisma = {
    ...
    category: {
      findMany: async ({ include }: { include?: { _count?: { select?: { posts?: boolean } } } } = {}) => {
        await new Promise((resolve) => setTimeout(resolve, 100))
      ...
      update: async ({ where, data }: { where: { id: string }; data: Partial<Category> }) => {
        await new Promise((resolve) => setTimeout(resolve, 100))
        const categoryIndex = mockCategories.findIndex((cat) => cat.id === where.id)
        if (categoryIndex === -1) throw new Error("Category not found")
  
        mockCategories[categoryIndex] = { ...mockCategories[categoryIndex], ...data, updatedAt: new Date() }
    ...
    post: {
      ...
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      create: async ({ data, include }: { data: Omit<Post, "id" | "createdAt" | "updatedAt">; include?: any }) => {
        await new Promise((resolve) => setTimeout(resolve, 100))
        const newPost: Post = {
          ...data,
          id: `post${Date.now()}`,
      ...
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      update: async ({ where, data, include }: { where: { id: string }; data: Partial<Post>; include?: any }) => {
        await new Promise((resolve) => setTimeout(resolve, 100))
        const postIndex = mockPosts.findIndex((post) => post.id === where.id)
        if (postIndex === -1) throw new Error("Post not found")
  
        mockPosts[postIndex] = { ...mockPosts[postIndex], ...data, updatedAt: new Date() }
        const updatedPost = mockPosts[postIndex]
  
        // Update user total likes if likes changed
        if (data.likes !== undefined) {
          const author = mockUsers.find((user) => user.id === updatedPost.authorId)
          if (author) {
      ...
      delete: async ({ where }: { where: { id: string } }) => {
        ...
        const commentIndices = mockComments
          ...
          .filter((i) => i !== -1)
        commentIndices.reverse().forEach((index) => mockComments.splice(index, 1))
    ...
    comment: {
      findMany: async ({
        ...
        if (where?.postId) {
          comments = comments.filter((comment) => comment.postId === where.postId)
        }
        if (where?.authorId) {
          comments = comments.filter((comment) => comment.authorId === where.authorId)
        }
      ...
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      create: async ({ data, include }: { data: Omit<Comment, "id" | "createdAt" | "updatedAt">; include?: any }) => {
        await new Promise((resolve) => setTimeout(resolve, 100))
      ...
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      update: async ({ where, data, include }: { where: { id: string }; data: Partial<Comment>; include?: any }) => {
        await new Promise((resolve) => setTimeout(resolve, 100))
        const commentIndex = mockComments.findIndex((comment) => comment.id === where.id)
        ...
        // Update user total likes if likes changed
        if (data.likes !== undefined) {
          const author = mockUsers.find((user) => user.id === updatedComment.authorId)
          if (author) {
            author.totalLikes = calculateUserTotalLikes(author.id)
          }
        }
      ...
      delete: async ({ where }: { where: { id: string } }) => {
        ...
        // Update author's total likes
        const author = mockUsers.find((user) => user.id === deletedComment.authorId)
        if (author) {
          author.totalLikes = calculateUserTotalLikes(author.id)
        }
    ...
    like: {
      findMany: async ({
        ...
        if (orderBy?.createdAt === "desc") {
          likes = [...likes].sort((a, b) => b.createdAt.getTime() - a.createdAt.getTime())
        }
  
        return likes
      },
      findFirst: async ({ where }: { where: { userId: string; postId?: string; commentId?: string } }) => {
        await new Promise((resolve) => setTimeout(resolve, 100))
        return (
          mockLikes.find(
            (like) => like.userId === where.userId && like.postId === where.postId && like.commentId === where.commentId,
          ) || null
        )
      },
      ...
      delete: async ({ where }: { where: { id: string } }) => {
        ...
        if (deletedLike.commentId) {
          const comment = mockComments.find((c) => c.id === deletedLike.commentId)
          if (comment) {
